...
// /*======= SWIPER DISCOVER (Initialize Swiper) ========*/
...
// sr.reveal(`.home__data, .home__social-link, .discover__container, .experience__data, .experience__overlay, .place__card, .sponsor__content, .footer__data, .footer__rights`, {
//   origin: "top",
//   interval: 100,
// });
...
// sr.reveal(`.home__info, .about__img-overlay, .video__content, .subscribe__form`, {
//   origin: "right",
//   interval: 100,
// });
